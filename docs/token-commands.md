...
| `CKA_TOKEN`                           | 0x00000001                               | boolean        | CK_BBOOL        |
...
| `CKA_ISSUER`                          | 0x00000081                               | bin 8/16/32    | DER encoded certificate issuer |
| `CKA_SERIAL_NUMBER`                   | 0x00000082                               | bin 8/16/32    | DER encoded certificate serial number |
| `CKA_AC_ISSUER`                       | 0x00000083                               | bin 8/16/32    | DER encoded certificate issuer |
| `CKA_OWNER`                           | 0x00000084                               | bin 8/16/32    | DER encoded certificate subject |
| `CKA_ATTR_TYPES`                      | 0x00000085                               | bin 8/16/32    | BER encoded certificate attributes |
| `CKA_TRUSTED`                         | 0x00000086                               | boolean        | CK_BBOOL        |
| `CKA_CERTIFICATE_CATEGORY`            | 0x00000087                               | uint 8/16/32   | CK_ULONG        |
| `CKA_JAVA_MIDP_SECURITY_DOMAIN`       | 0x00000088                               | ---            |                 |
| `CKA_URL`                             | 0x00000089                               | bin 8/16/32    | RFC2289 string            |
| `CKA_HASH_OF_SUBJECT_PUBLIC_KEY`      | 0x0000008A                               | bin 8/16/32    | hash of public key        |
| `CKA_HASH_OF_ISSUER_PUBLIC_KEY`       | 0x0000008B                               | bin 8/16/32    | hash of issuer public key |
| `CKA_CHECK_VALUE`                     | 0x00000090                               | bin 8/16/32    | key checksum              |
| `CKA_KEY_TYPE`                        | 0x00000100                               | uint 8/16/32   | CK_KEY_TYPE |
| `CKA_SUBJECT`                         | 0x00000101                               | bin 8/16/32    | DER encoded subject |
| `CKA_ID`                              | 0x00000102                               | bin 8/16/32    | key identifier for public/privatekey pair |
| `CKA_SENSITIVE`                       | 0x00000103                               | boolean        | CK_BBOOL |
| `CKA_ENCRYPT`                         | 0x00000104                               | boolean        | CK_BBOOL |
| `CKA_DECRYPT`                         | 0x00000105                               | boolean        | CK_BBOOL |
| `CKA_WRAP`                            | 0x00000106                               | boolean        | CK_BBOOL |
| `CKA_UNWRAP`                          | 0x00000107                               | boolean        | CK_BBOOL |
| `CKA_SIGN`                            | 0x00000108                               | boolean        | CK_BBOOL |
| `CKA_SIGN_RECOVER`                    | 0x00000109                               | boolean        | CK_BBOOL |
| `CKA_VERIFY`                          | 0x0000010A                               | boolean        | CK_BBOOL |
| `CKA_VERIFY_RECOVER`                  | 0x0000010B                               | boolean        | CK_BBOOL |
| `CKA_DERIVE`                          | 0x0000010C                               | boolean        | CK_BBOOL |
| `CKA_START_DATE`                      | 0x00000110                               | bin 8/16/32    | CK_DATE (encoded as BCD yyyy-mm-dd) |
| `CKA_END_DATE`                        | 0x00000111                               | bin 8/16/32    | CK_DATE (encoded as BCD yyyy-mm-dd) |
| `CKA_MODULUS`                         | 0x00000120                               | bin 8/16/32    | BIGINT of modulus |
| `CKA_MODULUS_BITS`                    | 0x00000121                               | uint 8/16/32   | size of modulus in bits |
| `CKA_PUBLIC_EXPONENT`                 | 0x00000122                               | bin 8/16/32    | BIGINT of public exponent |
| `CKA_PRIVATE_EXPONENT`                | 0x00000123                               | bin 8/16/32    | BIGINT of public exponent |
| `CKA_PRIME_1`                         | 0x00000124                               | bin 8/16/32    | BIGINT of prime P |
| `CKA_PRIME_2`                         | 0x00000125                               | bin 8/16/32    | BIGINT of prime Q |
| `CKA_EXPONENT_1`                      | 0x00000126                               | bin 8/16/32    | BIGINT of Private exponent d modulo p -1 |
| `CKA_EXPONENT_2`                      | 0x00000127                               | bin 8/16/32    | BIGINT of Private exponent d modulo q -1 |
| `CKA_COEFFICIENT`                     | 0x00000128                               | bin 8/16/32    | BIGINT of CRT coefficient q -1 mod p |
| `CKA_PRIME`                           | 0x00000130                               | bin 8/16/32    | BIGINT of prime |
| `CKA_SUBPRIME`                        | 0x00000131                               | bin 8/16/32    | BIGINT of subprime |
| `CKA_BASE`                            | 0x00000132                               | bin 8/16/32    | BIGINT of base |
| `CKA_PRIME_BITS`                      | 0x00000133                               | uint 8/16/32   | size of prime in bits |
| `CKA_SUBPRIME_BITS`                   | 0x00000134                               | uint 8/16/32   | size of subprime in bits |
| `CKA_SUB_PRIME_BITS`                  | 0x00000134                               | uint 8/16/32   | size of subprime in bits |
| `CKA_VALUE_BITS`                      | 0x00000160                               | uint 8/16/32   | size of private value x in bits |
| `CKA_VALUE_LEN`                       | 0x00000161                               | uint 8/16/32   | leng of value in bytes |
| `CKA_EXTRACTABLE`                     | 0x00000162                               | boolean        | CK_BBOOL |
| `CKA_LOCAL`                           | 0x00000163                               | boolean        | CK_BBOOL |
| `CKA_NEVER_EXTRACTABLE`               | 0x00000164                               | boolean        | CK_BBOOL |
| `CKA_ALWAYS_SENSITIVE`                | 0x00000165                               | boolean        | CK_BBOOL |
| `CKA_KEY_GEN_MECHANISM`               | 0x00000166                               | uint 8/16/32   | CK_MECHANISM_TYPE |
| `CKA_MODIFIABLE`                      | 0x00000170                               | boolean        | CK_BBOOL |
| `CKA_ECDSA_PARAMS`                    | 0x00000180                               | ---            | ---      |
| `CKA_EC_PARAMS`                       | 0x00000180                               | bin 8/16/32    | DER-encoding of an ANSI X9.62 Parameters value |
| `CKA_EC_POINT`                        | 0x00000181                               | bin 8/16/32    | DER-encoding of ANSI X9.62 ECPoint value Q |
| ~~CKA_SECONDARY_AUTH~~                | ~~0x00000200~~                           | ---            | --- |
| `CKA_ALWAYS_AUTHENTICATE`             | 0x00000202                               | boolean        | CK_BBOOL |
| ~~CKA_AUTH_PIN_FLAGS~~                | ~~0x00000201~~                           | ---            | --- |
| `CKA_WRAP_WITH_TRUSTED`               | 0x00000210                               | boolean        | CK_BBOOL |
| `CKA_WRAP_TEMPLATE`                   | (CKF_ARRAY_ATTRIBUTE &#124; 0x00000211)  | bin 8/16/32    | serialized wrap template (FIXME) |
| `CKA_UNWRAP_TEMPLATE`                 | (CKF_ARRAY_ATTRIBUTE &#124; 0x00000212)  | bin 8/16/32    | serialized unwrap template (FIXME) |
| `CKA_DERIVE_TEMPLATE`                 | (CKF_ARRAY_ATTRIBUTE &#124; 0x00000213)  | bin 8/16/32    | serialized derive template (FIXME) |
| `CKA_OTP_FORMAT`                      | 0x00000220                               | uint 8/16/32   | CK_ULONG |
| `CKA_OTP_LENGTH`                      | 0x00000221                               | uint 8/16/32   | CK_ULONG |
| `CKA_OTP_TIME_INTERVAL`               | 0x00000222                               | uint 8/16/32   | CK_ULONG |
| `CKA_OTP_USER_FRIENDLY_MODE`          | 0x00000223                               | boolean        | CK_BBOOL |
| `CKA_OTP_CHALLENGE_REQUIREMENT`       | 0x00000224                               | uint 8/16/32   | CK_ULONG |
| `CKA_OTP_TIME_REQUIREMENT`            | 0x00000225                               | uint 8/16/32   | CK_ULONG |
| `CKA_OTP_COUNTER_REQUIREMENT`         | 0x00000226                               | uint 8/16/32   | CK_ULONG |
| `CKA_OTP_PIN_REQUIREMENT`             | 0x00000227                               | uint 8/16/32   | CK_ULONG |
| `CKA_OTP_COUNTER`                     | 0x0000022E                               | bin 8/16/32    | internal state of counter |
| `CKA_OTP_TIME`                        | 0x0000022F                               | bin 8/16/32    | RFC 2279 stiring |
| `CKA_OTP_USER_IDENTIFIER`             | 0x0000022A                               | bin 8/16/32    | RFC 2279 stiring |
| `CKA_OTP_SERVICE_IDENTIFIER`          | 0x0000022B                               | bin 8/16/32    | RFC 2279 stiring |
| `CKA_OTP_SERVICE_LOGO`                | 0x0000022C                               | bin 8/16/32    | logo image |
| `CKA_OTP_SERVICE_LOGO_TYPE`           | 0x0000022D                               | bin 8/16/32    | logo mime type |
| `CKA_GOSTR3410_PARAMS`                | 0x00000250                               | bin 8/16/32    | DER-encoding of the object id |
| `CKA_GOSTR3411_PARAMS`                | 0x00000251                               | bin 8/16/32    | DER-encoding of the object id |
| `CKA_GOST28147_PARAMS`                | 0x00000252                               | bin 8/16/32    | DER-encoding of the object id |
| `CKA_HW_FEATURE_TYPE`                 | 0x00000300                               | ---            |          |
| `CKA_RESET_ON_INIT`                   | 0x00000301                               | boolean        | CK_BBOOL |
| `CKA_HAS_RESET`                       | 0x00000302                               | boolean        | CK_BBOOL |
| `CKA_PIXEL_X`                         | 0x00000400                               | uint 8/16/32   | screen resolution X |
| `CKA_PIXEL_Y`                         | 0x00000401                               | uint 8/16/32   | screen resolution Y |
| `CKA_RESOLUTION`                      | 0x00000402                               | uint 8/16/32   | screen pixel per inch |
| `CKA_CHAR_ROWS`                       | 0x00000403                               | uint 8/16/32   | characters per row |
| `CKA_CHAR_COLUMNS`                    | 0x00000404                               | uint 8/16/32   | characters per column |
| `CKA_COLOR                            | 0x00000405                               | boolean        | CK_BBOOL |
| `CKA_BITS_PER_PIXEL`                  | 0x00000406                               | uint 8/16/32   | bits per pixel |
| `CKA_CHAR_SETS`                       | 0x00000480                               | bin 8/16/32    | RFC 2279 character set |
| `CKA_ENCODING_METHODS`                | 0x00000481                               | bin 8/16/32    | RFC 2279 string |
| `CKA_MIME_TYPES`                      | 0x00000482                               | bin 8/16/32    | RFC 2279 string |
| `CKA_MECHANISM_TYPE`                  | 0x00000500                               | bin 8/16/32    | RFC 2279 string |
| `CKA_REQUIRED_CMS_ATTRIBUTES`         | 0x00000501                               | ---            | --- |
| `CKA_DEFAULT_CMS_ATTRIBUTES`          | 0x00000502                               | ---            | --- |
| `CKA_SUPPORTED_CMS_ATTRIBUTES`        | 0x00000503                               | ---            | --- |
| `CKA_ALLOWED_MECHANISMS`              | (CKF_ARRAY_ATTRIBUTE &#124; 0x00000600)  | array 16/32    | array of CK_MECHANISM_TYPE |
| `CKA_VENDOR_DEFINED`                  | 0x80000000                               | ---            | flags indicated that type is vendor specific |
